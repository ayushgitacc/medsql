          ...
          <div className="chat-scroll" style={{
            ...
            {messages.length === 0 && !resultData && (
              <div style={{ margin: "auto", textAlign: "center", padding: 24 }}>
                ...
                <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 6, color: d ? "rgb(255, 255, 255)" : "rgba(0, 0, 0, 0.87)", fontFamily: "'Roboto', sans-serif" }}>Ask Me Anythin</div>
                <div style={{ fontSize: 12, color: d ? "rgba(255, 255, 255, 0.61)" : "rgba(0,0,0,0.87)", lineHeight: 1.8, fontFamily: "'Roboto', sans-serif" }}>
                  Query your patient medical database using natural language
                </div>
              </div>
            )}
